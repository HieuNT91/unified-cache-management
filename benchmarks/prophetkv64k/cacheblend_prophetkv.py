...
CASES=('baseline','prophetkv-20','prophetkv-30','prophetkv-40','prophetkv-50')
...
def main():
    ...
    if p['sources']['benchmarks/prophetkv64k/cacheblend_prophetkv.py']!=sha(__file__):raise RuntimeError('Worker changed')
