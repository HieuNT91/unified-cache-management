...
REPO = Path(os.environ.get('PROPHETKV_REPO', Path(__file__).resolve().parents[1]))
ROOT = REPO / '.results/prophetkv-qwen3-ruler30-20260918'
PYTHON = REPO / '.envs/cacheblend/bin/python'
GPU_UUIDS = {1:'GPU-02dade44-3157-21e2-549f-7aa76931eb02',
             2:'GPU-90021bb8-8e9c-1225-eddd-4c43ce187cc6',
             3:'GPU-f7a26c8e-4455-7a74-3e75-f02c21d7c9e5',
